...
def reconstruct_post_predictions(predictions, parameters, crop_bbox, nib_volume, resampled_volume):
    ...
    if parameters.predictions_reconstruction_order == 'resample_first':
        resampled_predictions = __resample_predictions(predictions=predictions, crop_bbox=crop_bbox,
...
def __resample_predictions(predictions, crop_bbox, nib_volume, resampled_volume, reconstruction_method):
